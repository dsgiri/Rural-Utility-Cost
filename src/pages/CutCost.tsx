      ...
      <div className="p-6 md:p-8 flex-grow overflow-y-auto">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed font-medium">Estimate how much you need to reduce expenses to reach your target profit.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm relative overflow-hidden">
                ...
                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-6 uppercase tracking-tight relative z-10">Savings Estimate</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-6 bg-[#1a5f3f] dark:bg-[#11402a] text-white rounded-xl shadow-inner relative z-10">
                    <div className="flex justify-between items-end mb-2">
                      <p className="text-green-100 font-medium tracking-wide uppercase text-sm">Monthly Cost Cut Needed</p>
                    </div>
                  ...
                  <div className="p-6 bg-blue-600 dark:bg-blue-800 text-white rounded-xl shadow-inner relative z-10">
                    <div className="flex justify-between items-end mb-2">
                      <p className="text-blue-100 font-medium tracking-wide uppercase text-sm">Annual Savings Impact</p>
                    </div>
                    <div className="flex items-baseline gap-2">
              ...
              <ExportActions 
                calculatorName="Cut Cost Calculator"
                inputs={{ revenue, expenses, targetProfit }}
                results={{ currentProfit, requiredExpenses, costCutNeeded, annualSavings }}
              />
            </div>
          </div>
